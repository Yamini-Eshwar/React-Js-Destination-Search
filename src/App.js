  ...
  render(){
    ...
    return(
      <div className='app-container'>
          ...
          <input type="search" value={SearchInput} onChange={this.onChangeSearchInput} className="search-box"/> <span className="search-icon" ><img src="https://assets.ccbp.in/frontend/react-js/destinations-search-icon-img.png " alt=""/></span>
          <div class="gallery">
            {SearchResults.map(eachPlace =>(
                <DestinationSearch PlaceDetails={eachPlace} key={eachPlace.id} />
              ))
